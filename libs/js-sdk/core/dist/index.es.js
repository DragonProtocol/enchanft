...
var PROGRAM_ID = new PublicKey(idl.metadata.address);
var SynftSeed;
(function (SynftSeed) {
...
var SynftContract = /** @class */ (function () {
    function SynftContract(connection) {
        ...
        this.program = null;
        var provider = new AnchorProvider(connection, {}, AnchorProvider.defaultOptions());
        var program = new Program(idl, PROGRAM_ID, provider);
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.MINT_SEED), mintKey.toBuffer()], PROGRAM_ID)];
                    case 1:
                        _b = _f.sent(), nftMintPDA = _b[0], _b[1];
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.ACCOUNT_SEED), mintKey.toBuffer()], PROGRAM_ID)];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        injectSolAmount = new BN(solAmount);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.SOL), mintKey.toBuffer()], PROGRAM_ID)];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.PARENT_METADATA), rootMintKey.toBuffer()], program.programId)];
                    case 2:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.PARENT_METADATA), item.toBuffer()], program.programId)];
                                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.PARENT_METADATA), mintKey.toBuffer()], PROGRAM_ID)];
                    case 4:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        program = this.program;
                        connection = this._connection;
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.SOL), mintKey.toBuffer()], program.programId)];
                    case 1:
                        _a = _b.sent(), solPDA = _a[0], solBump = _a[1];
                        return [4 /*yield*/, connection.getTokenLargestAccounts(mintKey)];
                    case 2:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from(SynftSeed.PARENT_METADATA), mintKey.toBuffer()], program.programId)];
                    case 2:
                        _b = _c.sent(), parentPDA = _b[0], _b[1];
                        return [4 /*yield*/, PublicKey.findProgramAddress([Buffer.from("root-owner-seed"), mintKey.toBuffer()], program.programId)];
                    case 3:
...
export { PROGRAM_ID, SynftSeed, SynftContract as default };
