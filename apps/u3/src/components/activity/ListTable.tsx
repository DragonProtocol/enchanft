...
import { FamilyOrAppMapReverse, Types } from '../../constants/index';
      ...
      <TableContainer isMobile={isMobile}>
        ...
        <tbody>
          {data.map((item, idx) => {
            ...
            return (
              <tr key={`${item.streamId}_${item?.did}`}>
                <td>
                  <Link to={`/stream/${item.streamId}`}>
                ...
                <td>
                  {(item.domain && (
                    <div className="family-container">
                      <Link to={`/family/${encodeURIComponent(item.domain)}`}>
                    ...
                    <div className="family-container">
                      {(item.familyOrApp && (
                        <Link to={`/family/${item.familyOrApp}`}>
