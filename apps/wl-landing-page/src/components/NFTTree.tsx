        ...
        badges: [
          {
            ...
            type: 'text',
            value:
              lamportsToSol(sol.lamports).toFixed(VIEW_LAMPORTS_DECIMAL) +
              ' SOL',
            fill: '#fff',
            stroke: 'red',
            color: 'red',
  ...
  useEffect(() => {
    (async () => {
      const promises = nodes.map(async (item: TreeNode) => {
        ...
        const customData = {
          ...item.customData,
          curr: { ...item.customData.curr, ...data?.externalMetadata },
        };
      ...
      const newNodes = nodesRes.map((v: any) => {
        ...
        return {
          ...
          style: {
            ...
            icon: {
              ...newNode.style?.icon,
              value: newNode.customData.curr?.image || newNode.img,
            },
