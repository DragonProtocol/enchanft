...
// 列表信息，标准化数据为实体对象
export const launchpadUpcomingProjectsEntity =
  createEntityAdapter<ProjectItemForEntity>({
    selectId: (item) => item.id,
  });
// 初始化列表信息
const upcomingProjectsState: UpcomingProjectsState =
  launchpadUpcomingProjectsEntity.getInitialState({
