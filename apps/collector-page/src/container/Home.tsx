...
const Home: React.FC = () => {
  ...
  const searchTaskItems = formatStoreDataToComponentDataByTasks(tasks).slice(0, 4)
  const searchTasksLoading = searchTasksStatus === AsyncRequestStatus.PENDING ? true : false
  const searchProjectItems = formatStoreDataToComponentDataByProjects(projects).slice(0, 4)
    ...
    <HomeWrapper>
      ...
      <HomeCard>
        <CardHeader>
          ...
          <CardNavigateBtn onClick={() => navigate('/events')}>View All {'>>'}</CardNavigateBtn>
        </CardHeader>
      ...
      <HomeCard>
        <CardHeader>
          ...
          <CardNavigateBtn onClick={() => navigate('/projects')}>View All {'>>'}</CardNavigateBtn>
        </CardHeader>
