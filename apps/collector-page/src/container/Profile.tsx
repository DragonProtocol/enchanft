                  ...
                  <div className="thirdparty-btn">
                    <div
                      ...
                      onClick={() => {
                        // TODO 跳转回原页面
                        window.open(
                          'https://twitter.com/i/oauth2/authorize?response_type=code&client_id=bzBLMWs0NnBHejQ4a3dXYkROTHk6MTpjaQ&redirect_uri=https://dev.enchanft.xyz&scope=tweet.read+users.read+offline.access&state=3063390848298.8647&code_challenge=challenge&code_challenge_method=plain',
                          '__blank',
                        )
                      }}
                    >
