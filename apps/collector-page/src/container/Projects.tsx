...
import ExploreProjectSwiper, {
  ExplorProjectSwiperItemsType,
} from '../components/business/project/ExploreProjectSwiper';
...
const Projects: React.FC = () => {
  ...
  // recommend projects
  const { status: recommendProjectsStatus } = useAppSelector(
    selectExploreRecommendProjectsState
  );
  const recommendProjects = useAppSelector(
    selectAllForExploreRecommendProjects
  );
  useEffect(() => {
  ...
  const [searchProjectsFilter, setProjectsFilter] =
    useState<ExploreProjectIndexFilterDataType>({
  ...
  return (
    <ProjectsWrapper>
      ...
      <SearchProjectsBox>
        <ExploreProjectIndexFilter
          data={searchProjectsFilter}
          onChange={setProjectsFilter}
        />
        <ExploreProjectIndexList
