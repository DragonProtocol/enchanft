...
const CommunityContribution: React.FC<CommunityContributionProps> = ({
  items,
          ...
          <ContributionListBox>
            {items.map((item, index) => (
              <ContributionItemBox key={index}>
                ...
                <ContributionItemAvatar
                  user={{ id: item.userId, avatar: item.avatar }}
                />
                <ContributionItemUserName>
                  {item.userName}
                </ContributionItemUserName>
                <ContributionItemPubkey number={1}>
                  {item.pubkey}
