...
THREEx.DomEvent.prototype.bind = function (
  object3d,
  eventName,
  callback,
  useCapture
  ...
  console.assert(
    THREEx.DomEvent.eventNames.indexOf(eventName) !== -1,
...
THREEx.DomEvent.prototype._onEvent = function (
  eventName,
  mouseX,
  mouseY,
  origDomEvent
...
THREEx.DomEvent.prototype._notify = function (
  eventName,
  object3d,
  origDomEvent,
  targetFace
...
THREEx.DomEvent.prototype._onTouchStart = function (event) {
  return this._onTouchEvent('mousedown', event);
};
THREEx.DomEvent.prototype._onTouchEnd = function (event) {
